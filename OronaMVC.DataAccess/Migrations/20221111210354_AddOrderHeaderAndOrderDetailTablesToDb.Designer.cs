...
namespace OronaMVC.Migrations
{
    ...
    [Migration("20221111210354_AddOrderHeaderAndOrderDetailTablesToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OronaMVC.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OronaMVC.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OronaMVC.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OronaMVC.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OronaMVC.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("OronaMVC.Models.OrderDetail", b =>
                {
                    b.HasOne("OronaMVC.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OronaMVC.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("OronaMVC.Models.OrderHeader", b =>
                {
                    b.HasOne("OronaMVC.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("OronaMVC.Models.ApplicationUser", b =>
                {
                    b.HasOne("OronaMVC.Models.Company", "Company")
                        .WithMany()
